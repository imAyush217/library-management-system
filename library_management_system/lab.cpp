...
int libraryOptions() {
    cout << "0. Staff Login" << endl;
    cout << "1. Details Of All Library Staff" << endl;
    cout << "2. Member Registration" << endl;
    cout << "3. Member Login" << endl;
...
void loadBooksFromCSV() {
 string filePath = "C:/Users/patel/OneDrive/library_books.csv";
...
void returnBook() {
    ...
    for (auto& book : books) {
        if (book.id == id && book.status == "Borrowed") {
            ...
            if (overdueDays > 0) {
                int charges = overdueDays; // 1 pound per day
    ...
    if (!found) {
        cout << "No borrowed book found with ID " << id << endl;
    }
}
...
void home() {
    ...
    switch (option) {
        ...
        case 4:
            ...
            break;
        case 5:
            searchBook(); // Handle the search book option
            break;
        case 6:
            borrowBook();
            break;
